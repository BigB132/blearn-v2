...
from playwright.sync_api import sync_playwright, APIRequestContext, TimeoutError
import time
...
def run(playwright: sync_playwright):
    ...
    try:
        page.wait_for_url("http://localhost:3000/dashboard", timeout=5000)
    except TimeoutError:
        print("Failed to navigate to dashboard. Capturing screenshot of login page.")
